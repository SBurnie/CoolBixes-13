...
{
    public partial class AdventureWorksLT2017gr1Context : DbContext
    {
        public AdventureWorksLT2017gr1Context()
        {
        }

        public AdventureWorksLT2017gr1Context(DbContextOptions<AdventureWorksLT2017gr1Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server= 10.39.167.244\\SQLEXPRESS_316;Database=AdventureWorksLT2017gr1;User ID=Student516;Password=SecureSQL");
            }
        }
